      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoItem}>
            <Text style={styles.infoIcon}>📍</Text>
            <View style={{ flex: 1 }}>
              <Text style={styles.infoLabel}>Địa chỉ lấy hàng mặc định</Text>
...
const styles = StyleSheet.create({
  ...
  profileCard: {
    marginHorizontal: 20, backgroundColor: '#4f46e5', borderRadius: 16,
  ...
  profileRole: { fontSize: 13, color: 'rgba(255,255,255,0.8)', marginTop: 4 },
  card: {
