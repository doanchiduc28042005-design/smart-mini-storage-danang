    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full p-4 shadow-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 group"
        >
