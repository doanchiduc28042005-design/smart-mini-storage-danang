...
- ✅ **Real map integration** (Leaflet + OpenStreetMap, free, no API key) in all 3 apps
- ✅ **Location Picker** with Da Nang district presets + boundary check
- ✅ **4-tabs Box Management** by status (Chờ Lấy / Đã Lấy / Ở Hub / Đã Giao)
- ✅ **Customer Auth (JWT)** - register/login (email or phone) + protected dashboard
- ✅ **Terms & Conditions page** with legal content (5 sections + warning)
- ✅ **Mandatory terms checkbox** - must read before enabling
